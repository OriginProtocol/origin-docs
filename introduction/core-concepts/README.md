...
Origin's four yield token products ([OETH](../../protocol/oeth/), [Super OETH](../../protocol/super-oeth/), [OS](../../protocol/os/), and [OUSD](../../protocol/ousd/)) share most of the same battle-tested code. While each has its own characteristics and use cases, the same overall user experience applies across the product suite:
