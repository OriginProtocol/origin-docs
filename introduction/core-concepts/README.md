...
Origin's four yield-bearing token products ([OETH](../../products/oeth/), [Super OETH](../../products/super-oeth/), [OS](../../products/os/), and [OUSD](../../products/ousd/)) share most of the same battle-tested code. While each has its own characteristics and use cases, the same overall user experience applies across the product suite:
