...
* [os](protocol/os/ "mention") - Sonic's S-Tier LST bringing OETH's superior staking model to the world's fastest EVM chain. OS allows users to multiply their Sonic points and maximize their future airdrop through a variety of DeFi integrations.
* [super-oeth](protocol/super-oeth/ "mention") - The first Supercharged LST offering blended yield from Ethereum's Beacon Chain alongside liquidity incentives from other L2s/L1s. With substantially higher yield and a similar risk profile compared to LSTs, Super OETH provides a safe and sustainable alternative to speculative points games for users seeking to maximize yield on their ETH.
